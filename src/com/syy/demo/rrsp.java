...
public class rrsp {
	...
	public  AndroidDriver driver() throws Exception {
		...
		cap.setCapability("udid", "58Y0217C03001231"); // 设备的udid (adb
														// devices查看到的)
		cap.setCapability("appPackage", "com.zhongduomei.rrmj.society"); // 被测app的包名 
	...
	public void login() throws Exception {
		@SuppressWarnings("rawtypes")
		AndroidDriver driver = new rrsp().driver();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);// 隐式等待
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_account")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/sdv_my")).click();
		driver.findElement(By.xpath("//android.widget.TextView[contains(@index,2)]")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/start_account_psw_login")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/et_input_phone")).sendKeys("17521684314");
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/et_input_password")).sendKeys("123456");
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/start_login")).click();
		/* 断言：用户名是否为预期的 */
		String text = driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_nickname")).getText();
		assertEquals(text, "无敌四多么寂寞");
		System.out.println("使用账号密码登陆成功,账号为:"+text);
		
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		boolean flag = driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_nickname")).isDisplayed();
		if (flag) {
			driver.findElement(By.id("com.zhongduomei.rrmj.society:id/iv_setting")).click();
			Thread.sleep(1000);
			Actions.swipeUp(driver, 100, 2);
			driver.findElement(By.id("com.zhongduomei.rrmj.society:id/btn_user_exit_login")).click();
	...
	public void loginbyqq() throws Exception {
		 ...
		 * driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);//
		 * 隐式等待
		 * driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_account"
		 * )).click();
		 */
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_account")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/sdv_my")).click();
		driver.findElement(By.xpath("//android.widget.TextView[contains(@index,2)]")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/btn_login_SNS_qq")).click();
		Thread.sleep(2000);
	...
	public void loginbyWechat() throws Exception {
		...
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/sdv_my")).click();
		driver.findElement(By.xpath("//android.widget.TextView[contains(@index,2)]")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/btn_login_SNS_weixin")).click();
		/* 断言：用户名是否为预期的 */
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		String text = driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_nickname")).getText();
		assertEquals(text, "无敌四多么寂寞");
	...
	public void loginbyWeibo() throws Exception{
		...
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/sdv_my")).click();
		driver.findElement(By.xpath("//android.widget.TextView[contains(@index,2)]")).click();
		driver.findElement(By.id("com.zhongduomei.rrmj.society:id/btn_login_SNS_weibo")).click();
		/* 断言：用户名是否为预期的 */
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		String text = driver.findElement(By.id("com.zhongduomei.rrmj.society:id/tv_nickname")).getText();
		assertEquals(text, "无敌四多么寂寞");
